# Research: Profile Module v2 Redesign

**Feature**: 005-profile-v2-redesign
**Date**: 2026-09-21
**Status**: Complete — All decisions resolved. No open questions.
...
group changes, its documented component points scale proportionally to that group
total. Code falls back to the above table if any key is missing. A fresh environment
with an empty `SystemSettings` table must work correctly.
...
**Decision (Clarification Session 2026-09-22)**: `isMatchable` is exclusively
system-controlled. This decision requires the conflicting DEC-PROF-01 to be formally
