...
- Content inspection matching → 400 DOCUMENT_TYPE_MISMATCH if mismatched
- If storage upload succeeds but database record creation fails, delete the uploaded
  object immediately before returning the error
